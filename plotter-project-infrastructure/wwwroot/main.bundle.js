...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_observable_fromPromise__ = __webpack_require__(240);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_of__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_of__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_observable_throw__ = __webpack_require__(242);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_toPromise__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_toPromise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_toPromise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_mergeMap__ = __webpack_require__(245);
...
var ValuesClient = (function () {
    ...
    ValuesClient.prototype.getAll = function () {
        ...
        return this.http.request(url_, options_).map(function (_response) {
            return _this.processGetAll(_response);
        }).catch(function (_response) {
            if (_response instanceof __WEBPACK_IMPORTED_MODULE_9__angular_http__["c" /* Response */]) {
                try {
                    return _this.processGetAll(_response);
                }
                catch (e) {
                ...
                return __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["Observable"].throw(_response);
        });
    };
    ValuesClient.prototype.processGetAll = function (_response) {
        var _status = _response.status;
        if (_status === 200) {
            var _responseText = _response.text();
            var result200 = null;
    ...
    ValuesClient.prototype.processPost = function (_response) {
        var _status = _response.status;
        if (_status === 200) {
            var _responseText = _response.text();
            return __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["Observable"].of(null);
    ...
    ValuesClient.prototype.runExample = function (messageCount) {
        ...
        return this.http.request(url_, options_).map(function (_response) {
            return _this.processRunExample(_response);
        }).catch(function (_response) {
            if (_response instanceof __WEBPACK_IMPORTED_MODULE_9__angular_http__["c" /* Response */]) {
                try {
                    return _this.processRunExample(_response);
    ...
    ValuesClient.prototype.processRunExample = function (_response) {
        var _status = _response.status;
        if (_status === 200) {
            var _responseText = _response.text();
            var result200 = null;
    ...
    ValuesClient.prototype.processGet = function (_response) {
        var _status = _response.status;
        if (_status === 200) {
            var _responseText = _response.text();
            var result200 = null;
    ...
    ValuesClient.prototype.processPut = function (_response) {
        var _status = _response.status;
        if (_status === 200) {
            var _responseText = _response.text();
            return __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["Observable"].of(null);
    ...
    ValuesClient.prototype.processDelete = function (_response) {
        var _status = _response.status;
        if (_status === 200) {
            var _responseText = _response.text();
            return __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["Observable"].of(null);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_component__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__menu_menu_component__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__api_client__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ng_bootstrap_ng_bootstrap__ = __webpack_require__(166);
